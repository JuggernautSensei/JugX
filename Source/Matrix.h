...
struct alignas(16) MATRIX
{
    ...
    {
        return MATRIX {
            VECTOR4 { _scale.e[0],         0.f,         0.f, 0.f },
            VECTOR4 {         0.f, _scale.e[1],         0.f, 0.f },
            VECTOR4 {         0.f,         0.f, _scale.e[2], 0.f },
        ...
        const VECTOR3 _pyrRad)
    {
        ...
        return MATRIX {
            VECTOR4 { r00, r01, r02, 0.f },
            VECTOR4 { r10, r11, r12, 0.f },
            VECTOR4 { r20, r21, r22, 0.f },
            VECTOR4 { 0.f, 0.f, 0.f, 1.f }
        };
    }
        ...
        const float   _rad)
    {
        ...
        const float x = _axis.e[0];
        const float y = _axis.e[1];
        const float z = _axis.e[2];
        const float s = Sin(_rad);
        const float c = Cos(_rad);
        const float t = 1.f - c;

        return MATRIX {
            VECTOR4 {     t * x * x + c, t * x * y + s * z, t * x * z - s * y, 0.f },
            VECTOR4 { t * x * y - s * z,     t * y * y + c, t * y * z + s * x, 0.f },
            VECTOR4 { t * x * z + s * y, t * y * z - s * x,     t * z * z + c, 0.f },
            VECTOR4 {               0.f,               0.f,               0.f, 1.f }
        };
    }
        ...
        const VECTOR3 _up)
    {
        ...
        return MATRIX {
            VECTOR4 { r.e[0], r.e[1], r.e[2], 0.f },
            VECTOR4 { u.e[0], u.e[1], u.e[2], 0.f },
            VECTOR4 { f.e[0], f.e[1], f.e[2], 0.f },
            VECTOR4 {    0.f,    0.f,    0.f, 1.f }
        };
    }

    // =======================================================
    //  Factory (Fast Scale x Rotation x Translation)
    // =======================================================
        ...
        const VECTOR3 _translation)
    {
        ...
        return MATRIX {
            VECTOR4 { r.e[0] * _scale.e[0], r.e[1] * _scale.e[0], r.e[2] * _scale.e[0], 0.f },
            VECTOR4 { u.e[0] * _scale.e[1], u.e[1] * _scale.e[1], u.e[2] * _scale.e[1], 0.f },
            VECTOR4 { f.e[0] * _scale.e[2], f.e[1] * _scale.e[2], f.e[2] * _scale.e[2], 0.f },
            VECTOR4 {    _translation.e[0],    _translation.e[1],    _translation.e[2], 1.f }
        };
    }
    ...
    [[nodiscard]] JUG_MATH_API constexpr static MATRIX MakeSRT(
        ...
        const VECTOR3 _translation)
    {
        JUG_ASSERT(!IsAnyApproxZero(_scale), "Scale cannot have a zero component.");
        ...
        return {
            { _scale.e[0] * r00, _scale.e[0] * r01, _scale.e[0] * r02, 0.f },
            { _scale.e[1] * r10, _scale.e[1] * r11, _scale.e[1] * r12, 0.f },
            { _scale.e[2] * r20, _scale.e[2] * r21, _scale.e[2] * r22, 0.f },
            { _translation.e[0], _translation.e[1], _translation.e[2], 1.f }
        };
    }
        ...
        const VECTOR3 _translation)
    {
        ...
        return MATRIX {
            VECTOR4 {                                     r.e[0] * invs.e[0],                                     u.e[0] * invs.e[1],                                     f.e[0] * invs.e[2], 0.f },
            VECTOR4 {                                     r.e[1] * invs.e[0],                                     u.e[1] * invs.e[1],                                     f.e[1] * invs.e[2], 0.f },
            VECTOR4 {                                     r.e[2] * invs.e[0],                                     u.e[2] * invs.e[1],                                     f.e[2] * invs.e[2], 0.f },
            VECTOR4 { -(tx * r.e[0] + ty * r.e[1] + tz * r.e[2]) * invs.e[0], -(tx * u.e[0] + ty * u.e[1] + tz * u.e[2]) * invs.e[1], -(tx * f.e[0] + ty * f.e[1] + tz * f.e[2]) * invs.e[2], 1.f }
        };
    }
        ...
        const VECTOR3 _translation)
    {
        ...
        const float isx = 1.f / _scale.e[0], isy = 1.f / _scale.e[1], isz = 1.f / _scale.e[2];
        const float tx = _translation.e[0], ty = _translation.e[1], tz = _translation.e[2];
        ...
        const float _farZ)
    {
        ...
        return MATRIX {
            VECTOR4 {  xs, 0.f,             0.f, 0.f },
            VECTOR4 { 0.f,  ys,             0.f, 0.f },
            VECTOR4 { 0.f, 0.f,           range, 1.f },
            VECTOR4 { 0.f, 0.f, -range * _nearZ, 0.f }
        };
    }
        ...
        const float _farZ)
    {
        ...
        return MATRIX {
            VECTOR4 { _aspectRatio * invF,  0.f, 0.f,                   0.f },
            VECTOR4 {                 0.f, invF, 0.f,                   0.f },
            VECTOR4 {                 0.f,  0.f, 0.f, -d / (_farZ * _nearZ) },
            VECTOR4 {                 0.f,  0.f, 1.f,          1.f / _nearZ }
        };
    }
        ...
        const float _farZ)
    {
        ...
        return MATRIX {
            VECTOR4 {               2.f * invW,                      0.f,             0.f, 0.f },
            VECTOR4 {                      0.f,               2.f * invH,             0.f, 0.f },
            VECTOR4 {                      0.f,                      0.f,           range, 0.f },
            VECTOR4 { -(_left + _right) * invW, -(_top + _bottom) * invH, -range * _nearZ, 1.f }
        };
    }
        ...
        const float _farZ)
    {
        ...
        return MATRIX {
            VECTOR4 {                w * 0.5f,                     0.f,    0.f, 0.f },
            VECTOR4 {                     0.f,                h * 0.5f,    0.f, 0.f },
            VECTOR4 {                     0.f,                     0.f,      d, 0.f },
            VECTOR4 { (_right + _left) * 0.5f, (_top + _bottom) * 0.5f, _nearZ, 1.f }
        };
    }
    ...
    {
        return MATRIX { r[0] + _other.r[0], r[1] + _other.r[1], r[2] + _other.r[2], r[3] + _other.r[3] };
    }
        ...
        const MATRIX& _other) const
    {
        ...
        {
            const simd::M128 b0 = _other.r[0].ToSIMD();
            const simd::M128 b1 = _other.r[1].ToSIMD();
            const simd::M128 b2 = _other.r[2].ToSIMD();
            const simd::M128 b3 = _other.r[3].ToSIMD();
        ...
        const float b10 = _other.r[1].e[0], b11 = _other.r[1].e[1], b12 = _other.r[1].e[2], b13 = _other.r[1].e[3];
        const float b20 = _other.r[2].e[0], b21 = _other.r[2].e[1], b22 = _other.r[2].e[2], b23 = _other.r[2].e[3];
        const float b30 = _other.r[3].e[0], b31 = _other.r[3].e[1], b32 = _other.r[3].e[2], b33 = _other.r[3].e[3];

        // clang-format off
        return MATRIX {
            (r[0].e[0] * b00 + r[0].e[1] * b10) + (r[0].e[2] * b20 + r[0].e[3] * b30),
            (r[0].e[0] * b01 + r[0].e[1] * b11) + (r[0].e[2] * b21 + r[0].e[3] * b31),
            (r[0].e[0] * b02 + r[0].e[1] * b12) + (r[0].e[2] * b22 + r[0].e[3] * b32),
            (r[0].e[0] * b03 + r[0].e[1] * b13) + (r[0].e[2] * b23 + r[0].e[3] * b33),

            (r[1].e[0] * b00 + r[1].e[1] * b10) + (r[1].e[2] * b20 + r[1].e[3] * b30),
            (r[1].e[0] * b01 + r[1].e[1] * b11) + (r[1].e[2] * b21 + r[1].e[3] * b31),
            (r[1].e[0] * b02 + r[1].e[1] * b12) + (r[1].e[2] * b22 + r[1].e[3] * b32),
            (r[1].e[0] * b03 + r[1].e[1] * b13) + (r[1].e[2] * b23 + r[1].e[3] * b33),

            (r[2].e[0] * b00 + r[2].e[1] * b10) + (r[2].e[2] * b20 + r[2].e[3] * b30),
            (r[2].e[0] * b01 + r[2].e[1] * b11) + (r[2].e[2] * b21 + r[2].e[3] * b31),
            (r[2].e[0] * b02 + r[2].e[1] * b12) + (r[2].e[2] * b22 + r[2].e[3] * b32),
            (r[2].e[0] * b03 + r[2].e[1] * b13) + (r[2].e[2] * b23 + r[2].e[3] * b33),

            (r[3].e[0] * b00 + r[3].e[1] * b10) + (r[3].e[2] * b20 + r[3].e[3] * b30),
            (r[3].e[0] * b01 + r[3].e[1] * b11) + (r[3].e[2] * b21 + r[3].e[3] * b31),
            (r[3].e[0] * b02 + r[3].e[1] * b12) + (r[3].e[2] * b22 + r[3].e[3] * b32),
            (r[3].e[0] * b03 + r[3].e[1] * b13) + (r[3].e[2] * b23 + r[3].e[3] * b33)
        };
    }
...
[[nodiscard]] JUG_MATH_API constexpr MATRIX Abs(
    const MATRIX& _mtx)
{
    return MATRIX { Abs(_mtx.r[0]), Abs(_mtx.r[1]), Abs(_mtx.r[2]), Abs(_mtx.r[3]) };
}
    ...
    const MATRIX& _mtx)
{
    ...
    if (!std::is_constant_evaluated())
    {
        simd::M128 r0 = _mtx.r[0].ToSIMD();
        simd::M128 r1 = _mtx.r[1].ToSIMD();
...
#endif
    return MATRIX {
        VECTOR4 { _mtx.r[0].e[0], _mtx.r[1].e[0], _mtx.r[2].e[0], _mtx.r[3].e[0] },
        VECTOR4 { _mtx.r[0].e[1], _mtx.r[1].e[1], _mtx.r[2].e[1], _mtx.r[3].e[1] },
        VECTOR4 { _mtx.r[0].e[2], _mtx.r[1].e[2], _mtx.r[2].e[2], _mtx.r[3].e[2] },
        VECTOR4 { _mtx.r[0].e[3], _mtx.r[1].e[3], _mtx.r[2].e[3], _mtx.r[3].e[3] }
    };
}
...
namespace matrix_detail
{
        ...
        const MATRIX& _mtx)
    {
        ...
        const float m10 = _mtx.r[1].e[0], m11 = _mtx.r[1].e[1], m12 = _mtx.r[1].e[2], m13 = _mtx.r[1].e[3];
    ...
    float*        _outDet = nullptr)
{
    ...
    if (!std::is_constant_evaluated())
    {
        const simd::M128 row0 = _mtx.r[0].ToSIMD();
        const simd::M128 row1 = _mtx.r[1].ToSIMD();
        const simd::M128 row2 = _mtx.r[2].ToSIMD();
        const simd::M128 row3 = _mtx.r[3].ToSIMD();
